        ...
        <main className="w-full h-fit mt-14 px-4 gap-6 flex text-white items-center flex-col sm:mt-40 mb-10 bg-slate-900 md:gap-24 lg:px-[20%] text-center">
            ...
            <section className="flex flex-col justify-around bg-slate-900 flex-1 gap-10 lg:py-20">
                <header className="h-full w-full flex flex-col gap-10">
                    ...
                    <p className="text-gray-200/90 text-[16px] tracking-tight sm:text-xl sm:tracking-tight">
                        ...
                        and successfully attain your fitness objectives.
                    </p>
                </header>
                ...
                <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 items-center max-w-[800px] ">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-sm sm:text-[16px] text-gray-400 sm:text-left">
                            ...
                            standards. Review others&apos; training plans and
                            create your own!
                        </p>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-8 sm:gap-16 items-center max-w-[800px]">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-sm sm:text-[16px] text-gray-400 sm:text-left">
                            ...
                            Training plans can be easily added to the journal
                            for tracking.
                        </p>
                    </div>
                </div>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg hidden lg:flex">
                <table className="w-full text-left text-gray-500 dark:text-gray-400">
                    <caption className="p-5 text-2xl font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-900">
                        Features Preview
                        <p className="mt-1 text-lg font-normal text-gray-500 dark:text-gray-400">
                            How we compare
                        </p>
                    </caption>
                    <thead className="text-sm text-gray-700 uppercase bg-gray-50 dark:bg-gray-900 dark:text-gray-400">
                        <tr>
