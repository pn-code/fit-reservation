...
export default function LoginPage() {
    return (
        <main className="w-full min-h-[calc(100vh-90px)] bg-slate-900 py-6 rounded-md flex flex-col gap-4 shadow-md px-2 sm:px-10 text-white/90 justify-center items-center">
            <section className="w-[395px] flex flex-col gap-1 bg-white rounded-md p-6 text-black">
