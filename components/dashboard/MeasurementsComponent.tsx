...
import BodyFatForm from "@/components/dashboard/BodyFatForm";
...
export default function MeasurementsComponent() {
  ...
  const [weightsLastMonth, setWeightsLastMonth] = useState<WeightMeasurement[]>(
    []
  );
      ...
      <section className="flex flex-col gap-4 flex-1">
        ...
        <section className="flex flex-col gap-6">
          ...
          <section className="h-fit w-full rounded-md flex flex-col gap-2 flex-1">
            ...
            <span
              className={`text-xs sm:text-[16px] ${
                userWeightTrend < 0 ? "text-red-400" : "text-blue-400"
              }`}
            >
              {userWeightTrend
                ? `${userWeightTrend} lbs ${
                    weightsToDisplay === "month" ? "this month" : "all time"
                  }`
                : "Loading..."}
            </span>
          ...
          <section className="h-fit w-full rounded-md flex flex-col gap-2 flex-1 mt-5">
            ...
            <span
              className={`text-xs sm:text-[16px] ${
                userBodyFatTrend < 0 ? "text-red-400" : "text-blue-400"
              }`}
            >
              {userBodyFatTrend
                ? `${userBodyFatTrend} % ${
                    bodyFatsToDisplay == "month" ? "this month" : "all time"
                  }`
                : "Loading..."}
            </span>
