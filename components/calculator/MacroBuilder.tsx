...
export default function MacroBuilder({ currentCalorieGoal }: Props) {
    ...
    return (
        <section className="w-full lg:w-[30%] my-4">
            <header>
            ...
            <section className="flex md:justify-between flex-col gap-4">
                <section className="border-primary border-2 mt-2 p-4 w-full flex-1 flex flex-col items-center justify-center rounded-md bg-white">
                ...
                <form className="mb-2 flex flex-col gap-2 w-full flex-1">
