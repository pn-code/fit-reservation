  ...
  const handleCalculate = () => {
    try {
      ...
      if (gender == "male") {
        ...
        const formulaMale =
          (10 * weight * 0.453592 + 6.25 * totalHeightInCm - 5 * age + 5) *
            activity +
          plan;
      ...
      if (gender == "female") {
        ...
        const totalHeightInCm = feet * 12 * 2.54 + inches * 2.54;
        const formulaFemale =
          (10 * weight * 0.453592 + 6.25 * totalHeightInCm - 5 * age - 161) *
            activity +
          plan;
            ...
            <div className="flex flex-col gap-2">
              ...
              <section className="relative">
                <input
                  ...
                  type="tel"
                />
                <span className="absolute left-24 top-1 text-black">lb</span>
              </section>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex gap-2 flex-col w-72">
              ...
              >
                ...
                <option value={1.9}>2x hard exercise 6-7 days/wk</option>
              </select>
            </div>
      ...
      <section className="flex flex-col gap-2 my-4 w-full flex-1 lg:mt-20 justify-between">
        <section className="flex flex-col gap-2">
          ...
          <span className="text-sm text-red-400">
            * Calculate using our form or manually set by clicking calories.
          </span>
        </section>
