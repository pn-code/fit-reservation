                        ...
                        <div className="pb-2 w-full sm:w-[75%] lg:w-[40%]">
                            <div className="overflow-x-auto w-full">
                                <table className="table-auto w-full divide-y divide-primary border border-primary">
                                    ...
                                    <tbody>
                                        <tr className="bg-primary cursor-pointer text-white p-2">
                                            <td className="p-2 whitespace-nowrap bg-gray-800">
                                                TOTAL
                                            </td>
                                            <td className="p-2 whitespace-nowrap bg-gray-800">
                                                {
                                                    findTotalsFromJournalDate(
                                                        sortedJournals[date]
                                                    ).calories
                                                }
                                            </td>
                                            <td className="hidden sm:table-cell p-2 whitespace-nowrap bg-gray-800">
                                                {
                                                    findTotalsFromJournalDate(
                                                        sortedJournals[date]
                                                    ).carbs
                                            ...
                                            <td className="table-cell sm:hidden p-2 whitespace-nowrap bg-gray-800">
                                                {`${
                                                    findTotalsFromJournalDate(
                                                        sortedJournals[date]
                                                    ).carbs
