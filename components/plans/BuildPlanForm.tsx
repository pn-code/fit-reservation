    ...
    return (
        <section className="flex flex-col gap-4">
            <form className="flex flex-col gap-4 justify-center py-2 rounded-md md:flex-row">
                {/* Form Section */}
                <section className="flex flex-col w-full gap-4 bg-white border border-primary p-4 rounded-sm shadow-md">
                ...
                <section className="w-full flex flex-col gap-4 bg-white border border-primary p-4 rounded-sm shadow-md">
                        ...
                        <tbody className="text-sm divide-y divide-primary w-full border border-primary">
                            {exercises.length > 0 ? (
                                exercises.map((exercise, idx) => (
                                    <tr
                                        key={idx}
                                        className="w-full text-xs md:text-[14px] bg-white hover:bg-slate-100 cursor-pointer duration-200 border-primary border"
                                    >
